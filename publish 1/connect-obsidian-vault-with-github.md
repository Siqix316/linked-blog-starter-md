...
1. Create a repository or [[testa/publish 1/publish-your-obsidian-notes-with-linked-blog-starter|fork the md repo]] in github
...
![[testa/publish 1/attachments/create-pat-github.png]]
...
![[testa/publish 1/attachments/clone-repo-git-plugin.png]]
