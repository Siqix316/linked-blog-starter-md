...
![[testa/publish 1/attachments/fork-linked-blog-starter-md.png]]
...
![[testa/publish 1/attachments/configure-project-vercel.png]]
...
![[testa/publish 1/attachments/disconnect-repo-vercel.png]]
7. Then, [[testa/publish 1/get-project-id-account-id-and-token-vercel|get the account id, project id and token from vercel]]
...
![[testa/publish 1/attachments/github-secrets-vercel.png]]
9. Finally, click "Actions", and enable the workflow
![[testa/publish 1/attachments/enable-actions-github.png]]
...
Optionally, you can:
- [[testa/publish 1/connect-obsidian-vault-with-github|Publish Notes within your Obsidian Vault]] by installing the Obsidian Git plugin
- [[testa/publish 1/update-publish-settings-github-actions|Update the publish settings]] to publish your notes to a [[testa/publish 1/deploy-a-custom-linked-blog-starter|custom version]] of the linked-blog-starter 