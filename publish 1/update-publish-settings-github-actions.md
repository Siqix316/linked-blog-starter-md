...
- `BLOG_REPO`: Next.JS app repository template that is used to publish your markdown notes. This is useful when you [[testa/publish 1/deploy-a-custom-linked-blog-starter|create your own custom linked blog]]
...
![[testa/publish 1/attachments/publish-dir-yml.png]]