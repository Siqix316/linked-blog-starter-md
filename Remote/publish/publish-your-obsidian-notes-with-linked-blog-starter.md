...
![[testa/Remote/publish/attachments/fork-linked-blog-starter-md.png]]
...
![[testa/Remote/publish/attachments/configure-project-vercel.png]]
...
![[testa/Remote/publish/attachments/disconnect-repo-vercel.png]]
7. Then, [[testa/Remote/publish/get-project-id-account-id-and-token-vercel|get the account id, project id and token from vercel]]
...
![[testa/Remote/publish/attachments/github-secrets-vercel.png]]
9. Finally, click "Actions", and enable the workflow
![[testa/Remote/publish/attachments/enable-actions-github.png]]
...
Optionally, you can:
- [[testa/Remote/publish/connect-obsidian-vault-with-github|Publish Notes within your Obsidian Vault]] by installing the Obsidian Git plugin
- [[testa/Remote/publish/update-publish-settings-github-actions|Update the publish settings]] to publish your notes to a [[testa/Remote/publish/deploy-a-custom-linked-blog-starter|custom version]] of the linked-blog-starter 