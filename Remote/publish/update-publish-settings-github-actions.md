...
- `BLOG_REPO`: Next.JS app repository template that is used to publish your markdown notes. This is useful when you [[testa/Remote/publish/deploy-a-custom-linked-blog-starter|create your own custom linked blog]]
...
![[testa/Remote/publish/attachments/publish-dir-yml.png]]